...
public class FnStringEndsWith extends Fn {
    ...
    public void apply(int argc, Stack stack, Env env, Env fenv) {
        ...
        if (str.getStrValue().endsWith(pattern.getStrValue())) {
            stack.push(Symbol.T);
        } else {
    ...
    public String getDocstring() {
        return "(" + getName() + " pattern str) - function -  returns true if STR ends with PATTERN";
    }
