...
public class FnTruncate extends Fn {
    ...
    public void apply(int argc, Stack stack, Env env, Env fenv) {
        ...
        Number quotient = number.divide(divisor).truncate();
    ...
    public String getDocstring() {
        return "(" + getName() + " number &optional divisor) - function -  returns the truncation";
    }
